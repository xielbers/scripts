...
local function closeWindow()
    print("Cerrando ventana y deteniendo ejecución...") -- Log opcional
    Window:Destroy() -- Destruye la ventana principal
    while true do end -- Detiene el script con un bucle infinito
end
...
local function minimizeWindow()
    if not isMinimized then
        ...
        skullButton = Library:CreateButton(nil, "💀", function()
            Window.Visible = true -- Muestra la ventana principal
